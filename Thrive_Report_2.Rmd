...
load(file.path("rdata", "report2_data3.Rdata"))
report2_data3 <- first_last
```
...
\newline
![](plots/report2_chart5.png){ width=50% } ![](plots/report2_chart6.png){ width=50% }\
Change in number of pupils at each developmental stage between earliest and latest assessment date during 2014/15 academic year:\
Pupils at BEING             `r report2_data3$change_text[[1]]`\
Pupils at DOING             `r report2_data3$change_text[[2]]`\
Pupils at THINKING          `r report2_data3$change_text[[3]]`\
Pupils at POWER & IDENTITY  `r report2_data3$change_text[[4]]`\
\newline
